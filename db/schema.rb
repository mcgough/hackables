...
ActiveRecord::Schema.define(version: 20150505164110) do
  ...
  create_table "guides_tags", force: :cascade do |t|
    t.integer  "guide_id"
    t.integer  "tag_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_index "guides_tags", ["guide_id"], name: "index_guides_tags_on_guide_id"
  add_index "guides_tags", ["tag_id"], name: "index_guides_tags_on_tag_id"
